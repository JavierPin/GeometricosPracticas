...
public class Delaunay_Triangulation {
 ...
 public BoundingBox getBoundingBox() {
  return new BoundingBox(_bb_min, _bb_max);
    ...
    /**Devuelve el triangulo vecino a una arista dada de este triangulo
     * 
     * @return Triangle_dt
     */
    public Triangle_dt compartidoA1(Triangle_dt t){
        
        Vector<Triangle_dt> v1;
        v1 = findTriangleNeighborhood(t, t.b);

        Vector<Triangle_dt> v2;
        v2 = findTriangleNeighborhood(t, t.a);

        for (int i=0; i<v1.size();i++){

            for (int j=0; j<v2.size();j++){

                if (v1.get(i)==v2.get(j) && v1.get(i)!=t){
                    return v1.get(i);
    ...
    public Triangle_dt compartidoA2(Triangle_dt t){
        
        Vector<Triangle_dt> v1 = new Vector<Triangle_dt>();
        v1 = findTriangleNeighborhood(t, t.c);

        Vector<Triangle_dt> v2 = new Vector<Triangle_dt>();
        v2 = findTriangleNeighborhood(t, t.b);
    ...
    public Triangle_dt compartidoA3(Triangle_dt t){
        
        Vector<Triangle_dt> v1 = new Vector<Triangle_dt>();
        v1 = findTriangleNeighborhood(t, t.a);

        Vector<Triangle_dt> v2 = new Vector<Triangle_dt>();
        v2 = findTriangleNeighborhood(t, t.c);
    ...
    public Triangle_dt compartido(Triangle_dt t, Segment3d s){
